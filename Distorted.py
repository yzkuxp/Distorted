...
def Main():
    if sys.version_info[0] < 3:
        ...
        print(set_idk + "You are using python in version %s which is lower than python3 onward." %(version) + set_white)
        print(set_idk + "Please run the tool with a version higher than python 3.x.x." + set_white)
        sleep(3)
        exit(1)
    ...
    def Menu():
        ...
        if menuChoice == "1":
            ...
            if (Base64EncryptOrDecrypt == "A") or (Base64EncryptOrDecrypt == "a"):
                ...
                print(set_idk + "Invalid option, try again." + set_white)
                sleep(3)
                Apresentation()
                print("\t " + set_cyan + "[+] " + set_white + "Base64.")
                print("\t  " + set_magneta + "A" + set_white + ") " + set_cyan + "Encrypt." + set_white)
                ...
                if (Base64EncryptOrDecrypt == "A") or (Base64EncryptOrDecrypt == "a"):
                    ...
                    print(set_idk + "You've entered an invalid option twice, going back to menu." + set_white)
                    sleep(3)
                    Menu()
        elif menuChoice == "5":
            ReverseText()
            ...
            if (HexadecimalEncryptOrDecrypt == "A") or (HexadecimalEncryptOrDecrypt == "a"):
                ...
                print(set_idk + "Invalid option+ going back to menu." + set_white)
                sleep(3)
                Apresentation()
                print("\t " + set_cyan + "[+] " + set_white + "Hexadecimal.")
                print("\t  " + set_magneta + "A" + set_white + ") " + set_cyan + "Encrypt." + set_white)
            ...
            print(set_idk + "You've entered an invalid option. Please enter one of the listed options." + set_white)
            sleep(3)
            Menu()
